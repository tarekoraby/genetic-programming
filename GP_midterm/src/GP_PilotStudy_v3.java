...
public class GP_PilotStudy_v3 {
	double[] fitness;
	static double[] randNum;
	char[][] strategy_1, strategy_2, FT_strategy_1, FT_strategy_2;
	static Random rd = new Random();
	static final int MAX_LEN = 10000, POPSIZE = 10000, DEPTH = 5, GENERATIONS = 10000, TSIZE = 2,
			BESTRETAINED = 50, TESTCASES = 100, PROFILES = 1000, MINSYSTEM = 2, MAXSYSTEM = 9,
			RANDOMNUMBERS = 100;
	...
	public static void main(String[] args) {
		...
		GP_PilotStudy_v3 gp = new GP_PilotStudy_v3();
		gp.evolve();
		
	}

	public GP_PilotStudy_v3() {
	...
	void evolve() { 
		...
		FT_strategy_1 = new char[BESTRETAINED][];
		FT_strategy_2 = new char[BESTRETAINED][];
