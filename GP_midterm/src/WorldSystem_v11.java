...
public class WorldSystem_v11 {
	...
	public char[] strategy_init_2, strategy_init_3, strategy_init_4,
			strategy_join_3;
	char[] strategy;
	boolean[] warringA, warringB, surviving;
	int capChangeCount, testedStrategyIndex, counter;

	public WorldSystem_v11(int length, int testedStrategyIndex, double[] capabilities, double[] probabilities) {
		...
		capChangeCount = GP_PilotStudy_v11.CAPCHANGE;
	...
	public boolean simulate(char[] strategy_init_2, char[] strategy_init_3,
			char[] strategy_init_4, char[] strategy_join_3) {
				...
				if (surviving[i]) {
					if (i == testedStrategyIndex) {
						...
						if (currentStatesNum == 2)
							...
							strategy = strategy_init_3;
						else if (currentStatesNum == 4)
							strategy = strategy_init_4;
		...
		if (capChangeCount > 0) {
			...
			return (simulate(strategy_init_2, strategy_init_3, strategy_init_4,
					strategy_join_3));
		}
	...
	private void excuteAttack() {
		...
		GP_PilotStudy_v11.TC6++;
		GP_PilotStudy_v11.TC12++;
	}
