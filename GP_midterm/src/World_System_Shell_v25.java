...
public class World_System_Shell_v25 {
	...
	public World_System_Shell_v25(boolean simulateJoiner, int length) {
		...
		if (simulateJoiner) {
			...
			myEnmity = rd.nextInt(GP_PilotStudy_v25.ENMITYLEVELS - 1);
			oppEnmity = rd.nextInt(GP_PilotStudy_v25.ENMITYLEVELS - 1);
		}
		...
		if (GP_PilotStudy_v25.PROFILEPOWER)
