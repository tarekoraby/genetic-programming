...
public class World_System_Shell_v10 {
	...
	public World_System_Shell_v10(boolean simulateJoiner) { 
		this.simulateJoiner = simulateJoiner;
		currentStatesNum = GP_PilotStudy_v10.MINSYSTEM
				+ rd.nextInt(GP_PilotStudy_v10.MAXSYSTEM - GP_PilotStudy_v10.MINSYSTEM + 1);
		if (simulateJoiner) {
		...
		if (GP_PilotStudy_v10.PROFILEPOWER)
			for (int i = 0; i < currentStatesNum; i++)
