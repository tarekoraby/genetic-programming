...
public class implementClass_v15 implements Runnable {
	double[] fitness;
	static double[] randNum;
	Random rd = new Random();
	int TESTCASES, threadID;

	static final GP_PilotStudy_v15 X=new GP_PilotStudy_v15();
	...
	public implementClass_v15(int threadID, double[] randNum, int POPSIZE, double[] fitness,
	...
	double[] calculateFitness(int testCases) {
		...
		for (int test = 0; test < testCases; test++) {
			...
			for (int i = 0; i < POPSIZE; i++) {
				world = new WorldSystem_v15(length, testedStrategyIndex, capabilities, probabilities);
			...
			if (rd.nextDouble() < pmut) {
				...
				if (parentcopy[mutsite] < X.FSET_1_START) {
					...
					case GP_PilotStudy_v15.EQ:
						...
						break;
					case GP_PilotStudy_v15.AND:
						parentcopy[mutsite]=GP_PilotStudy_v15.OR;
						break;
					case GP_PilotStudy_v15.OR:
						parentcopy[mutsite]=GP_PilotStudy_v15.AND;
						break;
					}
			}
		}
