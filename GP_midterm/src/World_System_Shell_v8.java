...
public class World_System_Shell_v8 {
	...
	public World_System_Shell_v8(boolean simulateJoiner) { 
		this.simulateJoiner = simulateJoiner;
		currentStatesNum = GP_PilotStudy_v8.MINSYSTEM
				+ rd.nextInt(GP_PilotStudy_v8.MAXSYSTEM - GP_PilotStudy_v8.MINSYSTEM + 1);
		if (simulateJoiner) {
		...
		if (GP_PilotStudy_v8.PROFILEPOWER)
			for (int i = 0; i < currentStatesNum; i++)
