...
public class World_System_Shell_v24 {
	...
	public World_System_Shell_v24(boolean simulateJoiner, int length) {
		...
		if (simulateJoiner) {
			...
			myEnmity = rd.nextInt(GP_PilotStudy_v24.ENMITYLEVELS - 1);
			oppEnmity = rd.nextInt(GP_PilotStudy_v24.ENMITYLEVELS - 1);
		}
		...
		if (GP_PilotStudy_v24.PROFILEPOWER)
