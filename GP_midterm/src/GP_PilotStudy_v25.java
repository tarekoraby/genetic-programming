...
public class GP_PilotStudy_v25 {
	public static final boolean PROFILEPOWER = false;
	static int MASTER_GENERATIONS = 1000, DEME_GENERATIONS = 5, POPSIZE_PER_PROCESSOR = 125, MINRANDOM = 0, MAXRANDOM = 1,
	...
	static implementClass_v25[] implement;
	...
	static World_System_Shell_v25[][] profilingWorlds_Attacks, profilingWorlds_Joins;
	...
	static int[] length, world_sizes, TESTCASES = {1000, 1000};
	...
	public static void main(String[] args) {
		...
		for (currentSimulation = 1; currentSimulation <= simulations; currentSimulation++) {
			Simulation_v25 simulation_v25 = new Simulation_v25();
		}
	...
	private static void master_initalize() {
		...
		profilingWorlds_Attacks = new World_System_Shell_v25[uniqueWorldSizes][PROFILES_PER_CAT];
		profilingWorlds_Joins = new World_System_Shell_v25[uniqueWorldSizes - 1][PROFILES_PER_CAT];
		
		for (int i = 0; i < uniqueWorldSizes; i++) 
			for (int k = 0; k < PROFILES_PER_CAT; k++) 
				profilingWorlds_Attacks[i][k] = new World_System_Shell_v25(false, (i + MINSYSTEM));
		
		for (int i = 0; i < uniqueWorldSizes - 1; i++)
			for (int k = 0; k < PROFILES_PER_CAT; k++)
				profilingWorlds_Joins[i][k] = new World_System_Shell_v25(true, (i + MINSYSTEM + 1));
