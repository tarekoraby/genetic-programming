...
public class World_System_Shell_v6 {
	...
	public World_System_Shell_v6(boolean simulateJoiner) { 
		this.simulateJoiner = simulateJoiner;
		currentStatesNum = GP_PilotStudy_v6.MINSYSTEM
				+ rd.nextInt(GP_PilotStudy_v6.MAXSYSTEM - GP_PilotStudy_v6.MINSYSTEM + 1);
		if (simulateJoiner) {
