...
public class Simulation_v18 extends GP_PilotStudy_v18 {

	public Simulation_v18() {
	...
	private static void initiateThreads(int operationID) {
		...
		implement = new implementClass_v18[processors];

		for (int threadID = 0; threadID < processors; threadID++) {
			implement[threadID] = new implementClass_v18(threadID, randNum, POPSIZE_PER_PROCESSOR,
