...
public class WorldSystem_v12 {
	...
	public WorldSystem_v12(int length, int testedStrategyIndex, double[] capabilities, double[] probabilities) {
		...
		capChangeCount = GP_PilotStudy_v12.CAPCHANGE;
	...
	private void excuteAttack() {
		...
		GP_PilotStudy_v12.TC6++;
		GP_PilotStudy_v12.TC12++;
	}
