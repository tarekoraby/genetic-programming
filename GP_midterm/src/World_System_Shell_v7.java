...
public class World_System_Shell_v7 {
	...
	public World_System_Shell_v7(boolean simulateJoiner) { 
		this.simulateJoiner = simulateJoiner;
		currentStatesNum = GP_PilotStudy_v7.MINSYSTEM
				+ rd.nextInt(GP_PilotStudy_v7.MAXSYSTEM - GP_PilotStudy_v7.MINSYSTEM + 1);
		if (simulateJoiner) {
		...
		if (GP_PilotStudy_v7.PROFILEPOWER)
			for (int i = 0; i < currentStatesNum; i++)
