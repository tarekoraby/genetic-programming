...
public class World_System_Shell_v27 {
	...
	public World_System_Shell_v27(boolean simulateJoiner, int length) {
		...
		if (simulateJoiner) {
			...
			myEnmity = rd.nextInt(GP_PilotStudy_v27.ENMITYLEVELS - 1);
			oppEnmity = rd.nextInt(GP_PilotStudy_v27.ENMITYLEVELS - 1);
		}
		...
		if (GP_PilotStudy_v27.PROFILEPOWER)
