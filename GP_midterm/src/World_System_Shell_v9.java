...
public class World_System_Shell_v9 {
	...
	public World_System_Shell_v9(boolean simulateJoiner) { 
		this.simulateJoiner = simulateJoiner;
		currentStatesNum = GP_PilotStudy_v9.MINSYSTEM
				+ rd.nextInt(GP_PilotStudy_v9.MAXSYSTEM - GP_PilotStudy_v9.MINSYSTEM + 1);
		if (simulateJoiner) {
		...
		if (GP_PilotStudy_v9.PROFILEPOWER)
			for (int i = 0; i < currentStatesNum; i++)
