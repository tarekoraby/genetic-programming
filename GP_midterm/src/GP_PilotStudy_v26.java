...
public class GP_PilotStudy_v26 {
	public static final boolean PROFILEPOWER = false;
	static int MASTER_GENERATIONS = 10000, DEME_GENERATIONS = 5, POPSIZE_PER_PROCESSOR = 25, MINRANDOM = 0, MAXRANDOM = 1,
			PROFILES_PER_CAT = 1000, ENMITYLEVELS = 2, MINSYSTEM = 2, MAXSYSTEM = 3, MAX_LEN = 10000, DEPTH = 5,
	...
	public static final double RANDOMPLAYER_PROB = 0.1, STRATEGY_CHANGE_PROB = 0, ENHANCMENT_MARGIN = 0,
			PMUT_PER_NODE = 0.1, MOD_CROSSOVER_PROB = 0.1, REPLICATION_PROB = 0.1, CROSSOVER_PROB = 0.1,
			SUBTREE_MUT_PROB = 0.1, PMUT_PROB = 0.1, ABIOGENSIS_PROB = 0.5, GAUSS_PROB_FACTOR = 0;
	...
	static implementClass_v26[] implement;
	...
	static World_System_Shell_v26[][] profilingWorlds_Attacks, profilingWorlds_Joins;
	...
	static int[] length, world_sizes, TESTCASES = {500, 1000};
	...
	public static void main(String[] args) {
		...
		for (currentSimulation = 1; currentSimulation <= simulations; currentSimulation++) {
			Simulation_v26 simulation_v26 = new Simulation_v26();
		}
	...
	private static void master_initalize() {
		...
		profilingWorlds_Attacks = new World_System_Shell_v26[uniqueWorldSizes][PROFILES_PER_CAT];
		profilingWorlds_Joins = new World_System_Shell_v26[uniqueWorldSizes - 1][PROFILES_PER_CAT];
		
		for (int i = 0; i < uniqueWorldSizes; i++) 
			for (int k = 0; k < PROFILES_PER_CAT; k++) 
				profilingWorlds_Attacks[i][k] = new World_System_Shell_v26(false, (i + MINSYSTEM));
		
		for (int i = 0; i < uniqueWorldSizes - 1; i++)
			for (int k = 0; k < PROFILES_PER_CAT; k++)
				profilingWorlds_Joins[i][k] = new World_System_Shell_v26(true, (i + MINSYSTEM + 1));
