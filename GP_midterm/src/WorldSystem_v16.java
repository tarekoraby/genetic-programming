...
public class WorldSystem_v16 {
	...
	public WorldSystem_v16(int length, int testedStrategyIndex, double[] capabilities, double[] probabilities) {
		...
		capChangeCount = GP_PilotStudy_v16.CAPCHANGE;
	...
	private double run() {
		...
		switch (primitive) {
		case GP_PilotStudy_v16.CAPMED:
			return (capMed);
		case GP_PilotStudy_v16.CAPAVG:
			return (capAvg);
		case GP_PilotStudy_v16.CAPSTD:
			return (capStd);
		case GP_PilotStudy_v16.CAPMIN:
			return (capMin);
		case GP_PilotStudy_v16.CAPMAX:
			return (capMax);
		case GP_PilotStudy_v16.MYCAP:
			return (myCap);
		case GP_PilotStudy_v16.OPPCAP:
			return (oppCap);
		case GP_PilotStudy_v16.MYSIDECAP:
			return (mySideCap);
		case GP_PilotStudy_v16.LEFTCAPSUM:
			return (leftCapSum);
		...
		default:
			return (GP_PilotStudy_v16.randNum[primitive]);
		}
