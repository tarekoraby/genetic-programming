...
public class Simulation {
			...
			for (currentLevel = MasterVariables.MINSYSTEM; currentLevel <= MasterVariables.MAXSYSTEM; currentLevel++) {
				...
				for (currentDeme = 0; currentDeme < currentLevel; currentDeme++) {	
					...
					for (int i = 0; i < MasterVariables.GENERATIONS_PER_DEME; i++) {
						...
						demes[currentLevel - 2][currentDeme].strategies[0] = testedStrategies[0].getLevelStrategy(
						...
						bestStrategies[currentLevel - 2][currentDeme].bestStrategyFitness = testedStrategies[bestFitIndex].fitness;
	...
	private static void displayStatus() {
		...
		System.out.println(" " + currentLevel + "-" + (currentDeme + 1));
