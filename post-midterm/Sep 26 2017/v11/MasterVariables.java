...
public final class MasterVariables {
	...
	static final int MASTER_GENERATIONS = 50000, POPSIZE_PER_PROCESSOR = 25, MINRANDOM = 0, MAXRANDOM = 1000,
			PROFILES_PER_CAT = 1000, MINSYSTEM = 2, MAXSYSTEM = 8, MAX_LEN = 10000, DEPTH = 5, TSIZE = 2,
			GENERATIONS_PER_DEME = 10, simulations = 10;
	...
	static final int[] TESTCASES = {500, 500, 500, 500, 500, 500, 500};
