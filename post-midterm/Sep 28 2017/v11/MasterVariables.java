...
public final class MasterVariables {
	...
	///xxxx final
	static int MASTER_GENERATIONS = 5000, POPSIZE_PER_PROCESSOR = 25, MINRANDOM = 0, MAXRANDOM = 1000,
			PROFILES_PER_CAT = 1000, MINSYSTEM = 2, MAXSYSTEM = 8, MAX_LEN = 10000, DEPTH = 5, TSIZE = 2, simulations = 10;
	...
	static final int RANDOMNUMBERS = 20, CAPMED = RANDOMNUMBERS, CAPSD = CAPMED + 1, CAPMIN = CAPSD + 1,
			...
			FSET_3_END = OR;
	///xxxx final
	static double RANDOMPLAYER_PROB = 0.05, ENHANCMENT_MARGIN = 0, PMUT_PER_NODE = 0, MOD_CROSSOVER_PROB = 0.1,
