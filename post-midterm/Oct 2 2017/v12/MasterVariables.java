...
public final class MasterVariables {
	...
	///xxxx final
	static int MASTER_GENERATIONS = 10000, POPSIZE_PER_PROCESSOR = 25, MINRANDOM = 0, MAXRANDOM = 1000,
			PROFILES_PER_CAT = 1000, MINSYSTEM = 2, MAXSYSTEM = 8, MAX_LEN = 100000, DEPTH = 6, TSIZE = 2, simulations = 4;
			/* xxx GENERATIONS_PER_DEME = 10 */
	// xxx 
		static int GENERATIONS_PER_DEME = 10;
	// /xxxx final
	static final int RANDOMNUMBERS = 20, CAPMED = RANDOMNUMBERS, CAPSD = CAPMED + 1, CAP_1 = CAPSD + 1,
			...
			FSET_3_END = OR;
	///xxxx final
	static double RANDOMPLAYER_PROB = 0.002, ENHANCMENT_MARGIN = 0, PMUT_PER_NODE = 0, MOD_CROSSOVER_PROB = 0.1,
	...
	static final int[] TESTCASES = {100, 500, 500, 500, 500, 500, 500};
