...
public final class MasterVariables {
	...
	static final int MASTER_GENERATIONS = 30000, POPSIZE_PER_PROCESSOR = 250, MINRANDOM = 0, MAXRANDOM = 1,
	...
	static final double RANDOMPLAYER_PROB = 0.1, ENHANCMENT_MARGIN = 0, PMUT_PER_NODE = 0, MOD_CROSSOVER_PROB = 0.3,
			REPLICATION_PROB = 0, CROSSOVER_PROB = 0, SUBTREE_MUT_PROB = 0, PMUT_PROB = 0,
			ABIOGENSIS_PROB = 0.7, GAUSS_PROB_FACTOR = 0;
	...
	static final int[] TESTCASES = { 200, 1500, 2000 };
