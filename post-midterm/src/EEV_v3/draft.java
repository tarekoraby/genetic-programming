...
public class draft {
	...
	private static void testDieVarince(){
		rd = new Random();
	    for (int i = 10; i > 0; i--)
	    {
	      int Die1 = rd.nextInt(i + 1);
	...
	public static double calculateSampleSD(double numArray[])
    {
	...
	public static double calculatePopulationSD(double numArray[])
    {
        double sum = 0.0, standardDeviation = 0.0;
        int length = numArray.length;
