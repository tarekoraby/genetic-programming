...
public final class MasterVariables {
	...
	static int MASTER_GENERATIONS = 1000, POPSIZE_PER_PROCESSOR = 25, MINRANDOM = 0, MAXRANDOM = 1000,
			PROFILES_PER_CAT = 1000, MINSYSTEM = 2, MAXSYSTEM = 3, MAX_LEN = 10000, DEPTH = 6, TSIZE = 2, simulations = 10;
			/* xxx GENERATIONS_PER_DEME = 10 */
	// xxx 
		static int GENERATIONS_PER_DEME = 30;
	///xxxx final
	...
	static final int[] TESTCASES = {100, 500};
