...
public class MainClass {
	...
	static void printFileHeaders() {
		...
		try {
			...
			outputString = ("simulation" + "," + "generations_per_deme" + "," + "random_player_prob" + ","
					+ "interaction_rounds" + "," + "random_numbers" + "," + "stateNum" + "," + "generation" + ","
					+ "world_size" + "," + "total_inits" + "," + "total_balances" + "," + "total_bandwagons" + ","
					+ "total_joins" + "," + "init_fitness" + "," + "join_fitness");
			...
			outputString += ("," + "init_myCap_min" + "," + "init_myCap_med" + "," + "init_oppCap_min" + ","
					...
					+ "init_myEnmity_min" + "," + "init_myEnmity_med" + "," + "init_oppEnmity_min" + ","
					+ "init_oppEnmity_med" + "," + "balance_myCap_min" + "," + "balance_myCap_med" + ","
					+ "balance_oppCap_min" + "," + "balance_oppCap_med" + "," + "balance_capRatio_min" + ","
					+ "balance_capRatio_med" + "," + "balance_capMed_min" + "," + "balance_capMed_med" + ","
					+ "balance_capSD_min" + "," + "balance_capSD_med" + "," + "balance_cap_1_min" + ","
					+ "balance_cap_1_med" + "," + "balance_cap_2_min" + "," + "balance_cap_2_med" + ","
					+ "balance_cap_3_min" + "," + "balance_cap_3_med" + "," + "balance_cap_4_min" + ","
					+ "balance_cap_4_med" + "," + "balance_cap_5_min" + "," + "balance_cap_5_med" + ","
					+ "balance_cap_6_min" + "," + "balance_cap_6_med" + "," + "balance_cap_7_min" + ","
					+ "balance_cap_7_med" + "," + "balance_cap_8_min" + "," + "balance_cap_8_med" + ","
					...
					+ "," + "join_capRatio_med" + "," + "join_capMed_min" + "," + "join_capMed_med" + ","
					+ "join_capSD_min" + "," + "join_capSD_med" + "," + "join_cap_1_min" + "," + "join_cap_1_med" + ","
					+ "join_cap_2_min" + "," + "join_cap_2_med" + "," + "join_cap_3_min" + "," + "join_cap_3_med" + ","
					+ "join_cap_4_min" + "," + "join_cap_4_med" + "," + "join_cap_5_min" + "," + "join_cap_5_med" + ","
					+ "join_cap_6_min" + "," + "join_cap_6_med" + "," + "join_cap_7_min" + "," + "join_cap_7_med" + ","
					+ "join_cap_8_min" + "," + "join_cap_8_med" + "," + "join_smallerSideCap_min" + ","
					+ "join_smallerSideCap_med" + "," + "join_largerSideCap_min" + "," + "join_largerSideCap_med" + ","
