...
public final class MasterVariables {
	...
	static final int  MINRANDOM = -1, MAXRANDOM = 1, PROFILES_PER_CAT = 1000, MINSYSTEM = 2,
			MAXSYSTEM = 2, MAX_LEN = 10000, DEPTH = 5, TSIZE = 2, simulations = 1;

	static final char RANDOMNUMBERS = 20, CAPMED = RANDOMNUMBERS, CAPSD = CAPMED + 1, CAP_1 = CAPSD + 1,
	...
	static final double RANDOMPLAYER_PROB = 0, ENHANCMENT_MARGIN = 0, MOD_CROSSOVER_PROB = 0.1, REPLICATION_PROB = 0,
			CROSSOVER_PROB = 0.15, SUBTREE_MUT_PROB = 0.2, PMUT_PROB = 0.15,
	...
	static final int[] popSizes = { 1000 };
	static final int[] genPerLevel = { 250};
	...
	static int xxxJoinCounter, xxxbalanceCounter, xxxTotalCounter;
	...
	public static void initializeMasterVariables() {
		...
		totalProfileAttacksOrders = new double[simulations][uniqueWorldSizes][PROFILES_PER_CAT][MAXSYSTEM];
	...
	private static void CheckErrors() {
		...
		if (Math.abs(MOD_CROSSOVER_PROB + REPLICATION_PROB + CROSSOVER_PROB + SUBTREE_MUT_PROB
