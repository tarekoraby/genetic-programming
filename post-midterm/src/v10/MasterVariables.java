...
public final class MasterVariables {
	...
	static final int MASTER_GENERATIONS = 10000, POPSIZE_PER_PROCESSOR = 25, MINRANDOM = 0, MAXRANDOM = 1000,
			PROFILES_PER_CAT = 100, MINSYSTEM = 2, MAXSYSTEM = 3, MAX_LEN = 10000, DEPTH = 5, TSIZE = 2,
			GENERATIONS_PER_DEME = 1, simulations = 10;
	static final int RANDOMNUMBERS = 20, CAPMED = RANDOMNUMBERS, CAPSD = CAPMED + 1, CAPMIN = CAPSD + 1,
			...
			FSET_3_END = OR;
	static final double RANDOMPLAYER_PROB = 0.1, ENHANCMENT_MARGIN = 0, PMUT_PER_NODE = 0, MOD_CROSSOVER_PROB = 0.1,
	...
	static final int[] randNum = new int[RANDOMNUMBERS];
	static final Random rd = new Random();
	static final int[] TESTCASES = {600, 600};
