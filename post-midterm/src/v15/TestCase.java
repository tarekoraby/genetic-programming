...
public class TestCase {
	...
	Strategy[] strategies2;
	Strategy[][] strategies3;
	...
	public TestCase(double[] capabilities, double[][] capChangeRates, double[] randNums, double[] randGauss,
			...
			Strategy[] strategies2, Strategy[][] strategies3, int worldTypeNo, int order) {
		this.strategies2 = strategies2;
		this.strategies3 = strategies3;
		this.order = order;
				...
				if (i != testedStrategyIndex && randNums[randNumCounter++] < MasterVariables.RANDOMPLAYER_PROB) {
					...
					if (i == testedStrategyIndex && currentSystemSize == initialSystemSize) {
						if ((cap_1 < 0.5 && worldTypeNo == 1)
							...
							if (cap_1 < 0.5) {
								if (myCap == cap_1)
									strategy = strategies3[0][2].getJoinStrategy(3);
								else if (myCap == cap_2)
									strategy = strategies3[0][1].getJoinStrategy(3);
								else if (myCap == cap_3)
									strategy = strategies3[0][0].getJoinStrategy(3);
							} else {
								if (myCap == cap_1)
									strategy = strategies3[1][2].getJoinStrategy(3);
								else if (myCap == cap_2)
									strategy = strategies3[1][1].getJoinStrategy(3);
								else if (myCap == cap_3)
									strategy = strategies3[1][0].getJoinStrategy(3);
							}
						}
					} else if (cap_1 < 0.5) {
						if (myCap == cap_1)
					...
					if (run() == 1) {
						...
						if (i == testedStrategyIndex && currentSystemSize == initialSystemSize)
							if ((cap_1 < 0.5 && worldTypeNo == 1)
								...
								if (cap_1 < 0.5) {
									if (myCap == cap_1)
										strategy = strategies3[0][2].getBalanceStrategy(3);
									else if (myCap == cap_2)
										strategy = strategies3[0][1].getBalanceStrategy(3);
									else if (myCap == cap_3)
										strategy = strategies3[0][0].getBalanceStrategy(3);
								} else {
									if (myCap == cap_1)
										strategy = strategies3[1][2].getBalanceStrategy(3);
									else if (myCap == cap_2)
										strategy = strategies3[1][1].getBalanceStrategy(3);
									else if (myCap == cap_3)
										strategy = strategies3[1][0].getBalanceStrategy(3);
								}
							}
						else if (cap_1 < 0.5) {
							if (myCap == cap_1)
					...
					if (i == testedStrategyIndex && currentSystemSize == initialSystemSize) {
						if (currentSystemSize == 2) {
							if ((order == 1 && myCap == cap_1) || (order == 2 && myCap == cap_2)){								
								...
								strategy = strategies2[1].getInitStrategy(2);
							} else {
								strategy = strategies2[0].getInitStrategy(2);
							}
						} else {
							if (((cap_1 < 0.5 && worldTypeNo == 1) || (cap_1 > 0.5 && worldTypeNo == 2))
								...
								if (myCap == cap_1)
									strategy = strategies3[0][2].getInitStrategy(3);
								else if (myCap == cap_2)
									strategy = strategies3[0][1].getInitStrategy(3);
								else if (myCap == cap_3)
									strategy = strategies3[0][0].getInitStrategy(3);
							} else {
								if (myCap == cap_1)
									strategy = strategies3[1][2].getInitStrategy(3);
								else if (myCap == cap_2)
									strategy = strategies3[1][1].getInitStrategy(3);
								else if (myCap == cap_3)
									strategy = strategies3[1][0].getInitStrategy(3);
							}
						}
					} else {
						if (currentSystemSize == 2) {
