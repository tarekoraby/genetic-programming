...
public class Strategy {
	...
	//Strategy types can be 0, 1, or 2 for war initiation, balancing, and joining respectively
	private char[] getStrategy(int type, int worldSize) {
		...
		if (type == 2)
			return (join_stratgies[worldSize - MasterVariables.MINSYSTEM - 1]);
	...
	private void setStrategy(int type, int worldSize, char[] strategy) {
		...
		if (type == 2)
			join_stratgies[worldSize - MasterVariables.MINSYSTEM - 1] = strategy;
	}
