	...
	static void printFileHeaders() {
		...
		try {
			...
			outputString = ("simulation" + "," + "stateNum" + "," + "generation" + "," + "world_size" + ","
					+ "total_inits" + "," + "total_balances" + "," + "total_bandwagons" + "," + "total_joins");
			...
			outputString += ("," + "init_myCap_min" + "," + "init_myCap_med" + "," + "init_oppCap_min" + ","
					...
					+ "join_capMed_min" + "," + "join_capMed_med" + "," + "join_capStd_min" + ","
					+ "join_capStd_med" + "," + "join_capMin_min" + "," + "join_capMin_med" + ","
					+ "join_capMax_min" + "," + "join_capMax_med" + "," + "join_mySideCap_min" + ","
					+ "join_mySideCap_med" + "," + "join_leftCapSum_min" + "," + "join_leftCapSum_med"
